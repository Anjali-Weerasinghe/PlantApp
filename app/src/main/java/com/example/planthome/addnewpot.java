...
public class addnewpot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addnewpot);
        ...
        btn_add = (Button) findViewById(R.id.btn_addPots);
        btn_back = (ImageView) findViewById(R.id.btnback_image);
        add_Image = (ImageView) findViewById(R.id.add_ImagePots);
        add_ItemCode = (EditText) findViewById(R.id.addItemCode);
        add_Name = (EditText) findViewById(R.id.addItemName);
        add_Price = (EditText) findViewById(R.id.addItemPrice);
        add_Description = (EditText) findViewById(R.id.addItemDescription);
...
//        }
    ...
    private void StoreItemInformation() {
        loadingBar.setTitle("Add new Pot");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener(){
            ...
            public void onFailure (@NonNull Exception e){
                ...
                Toast.makeText(addnewpot.this,"Error: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>(){
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(addnewpot.this,"Item image uploaded successfully...", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(addnewpot.this, "got the item image url successfully..", Toast.LENGTH_SHORT).show();
        ...
        ItemsRef.child(itemKey).updateChildren(itemMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Intent intent = new Intent(addnewpot.this, addnewpot.class);
                                startActivity(intent);

                                loadingBar.dismiss();
                                Toast.makeText(addnewpot.this, "Item is added successfully..", Toast.LENGTH_SHORT).show();
